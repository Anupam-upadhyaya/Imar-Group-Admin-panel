<?php
/**
 * IMAR Group Admin Panel - Create Blog Post
 * File: admin/blog_create.php
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = $blogManager->createPost($_POST, $image_file);
...
<head>
    ...
    <title>Create Blog Post - IMAR Group Admin</title>
    ...
    <div class="main-content">
        <div class="dashboard-header">
            ...
            <div class="header-actions">
                ...
                <a href="blog.php" class="btn-secondary" style="padding: 8px 16px; text-decoration: none; display: inline-block; border-radius: 6px;">← Back to Blog</a>
            </div>
        </div>
        ...
        <div class="form-container">
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="form-hint">A clear, descriptive title that captures the main topic</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="excerpt" name="excerpt" required rows="3" 
                              placeholder="Brief summary of the post (used in previews and meta description)"></textarea>
                    <div class="form-hint">Keep it under 160 characters for SEO</div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="author_name" name="author_name" value="Bikram Gyawali">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-hint">Recommended size: 1200x675px (16:9 ratio). Max 5MB</div>
                ...
                <div class="form-group">
                    <label for="meta_title">SEO Title (Optional)</label>
                    <input type="text" id="meta_title" name="meta_title" maxlength="255" 
                           placeholder="Leave blank to use post title">
                </div>

                <div class="form-group">
                    <label for="meta_description">SEO Description (Optional)</label>
                    <textarea id="meta_description" name="meta_description" rows="2" 
                              placeholder="Leave blank to use excerpt"></textarea>
                </div>
