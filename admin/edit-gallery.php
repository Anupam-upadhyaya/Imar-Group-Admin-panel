    ...
    if (empty($title)) {
        ...
        if (isset($_FILES['image']) && $_FILES['image']['error'] !== UPLOAD_ERR_NO_FILE) {
            ...
            if (!in_array($file['type'], $allowed_types)) {
                ...
                // Delete old image
                $old_image_full = '../../Imar-Group-Website/' . $gallery_item['image_path'];
                ...
                if ($gallery_item['thumbnail_path']) {
                    $old_thumb_full = '../../Imar-Group-Website/' . $gallery_item['thumbnail_path'];
                ...
                $image_path = 'Gallery/' . $category_folder . '/' . $filename;
                
                if (move_uploaded_file($file['tmp_name'], $file_path)) {
                    // Create thumbnail
                    $thumbnail_full = createThumbnail($file_path, $upload_dir, $filename);
                    $thumbnail_path = $thumbnail_full ? 'Gallery/' . $category_folder . '/thumb_' . $filename : null;
                } else {
        ...
        if (empty($error_message)) {
            ...
            $stmt->bind_param("ssssssiiis", $title, $description, $image_path, $thumbnail_path, $category, $size_class, $is_featured, $display_order, $status, $gallery_id);
    ...
    <div class="main-content">
        <div class="dashboard-header">
            <div>
                ...
                <p style="color: #6b7280; margin-top: 5px;">Update gallery item details and image</p>
            </div>
            ...
            <div class="form-container">
                ...
                <div class="form-group">
                    ...
                    <div class="current-image">
                        <img src="../../Imar-Group-Website/<?php echo htmlspecialchars($gallery_item['image_path']); ?>" 
